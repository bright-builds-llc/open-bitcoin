...
Plans:
- [ ] 133.1-01-PLAN.md — Capture the 82-finding/stale-LOC baseline, Rust test inventories, and repair numbered lesson metadata.
- [ ] 133.1-02-PLAN.md — Split chainstate, consensus, mempool, and wallet Rust tests with exact leaf-name and breadcrumb preservation.
- [ ] 133.1-03-PLAN.md — Split CLI, network, node, and RPC Rust tests with exact leaf-name and breadcrumb preservation.
- [ ] 133.1-04-PLAN.md — Decompose all 20 oversized non-live TypeScript checker, fixture, and test files.
...
| 133.1. Bright Builds Verification Baseline Cleanup | 0/6 | Not started | - |
