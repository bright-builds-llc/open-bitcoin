...
**Status:** Integration gap closure active. Phase 127 is lifecycle-valid and independently verified, raising the active requirement projection to 33/39; Phases 128 and 129 remain pending before the canonical integration audit is rerun.
...
- v2.1 retains its bounded, explicit, default-off block-serving and compact-relay claim while Phases 127 through 129 close three audited production-boundary gaps. Phase 127 is complete, 33/39 requirements are now promoted, and active routing advances to `/gsd-plan-phase 128`.
