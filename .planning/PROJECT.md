...
**Status:** Integration gap closure active. Phase 128 is lifecycle-valid and independently verified, raising the active requirement projection to 36/39; Phase 129 remains pending before the canonical integration audit is rerun.
...
- v2.1 retains its bounded, explicit, default-off block-serving and compact-relay claim while Phase 129 closes the remaining integration-guardrail and milestone-reconciliation work. Phase 128 is complete, 36/39 requirements are promoted, and active routing advances to `/gsd-plan-phase 129`.
...
| Scope v2.1 to block serving and compact block relay boundaries | v2.0 shipped bounded transaction relay and mempool participation, so the next safe node-participation expansion is serving validated blocks and compact-block relay before package relay, public defaults, or production full-node readiness | Phase 128 production compact-announcement transport is verified; Phase 129 owns final integration guardrails and milestone reconciliation |
...
***
*Last updated: 2026-07-20 after Phase 128 production compact-announcement transport verification*
