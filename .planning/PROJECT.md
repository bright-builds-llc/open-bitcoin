...
**Status:** Phases 110–124 implementation evidence remains complete, and Phase 125 traceability closure passed for `RCN-04`, `RCN-05`, and `RCN-06` with summary bookkeeping still pending. The milestone has 33/39 requirements complete; Phase 126 retains `CMP-05`, `RCN-02`, `RCN-03`, `GOV-04`, `BOUND-01`, and `HARD-05`. Archival is blocked until Phase 126 passes verification and final reconciliation produces a fresh archive decision.
...
- v2.1 retains its bounded, explicit, default-off block-serving and compact-relay claim with 33/39 requirements complete and 6/39 pending. Phase 125 verification traceability passed for `RCN-04`, `RCN-05`, and `RCN-06`; Phase 126 must close `CMP-05`, `RCN-02`, `RCN-03`, `GOV-04`, `BOUND-01`, and `HARD-05`. Archival remains blocked.
...
| Scope v2.1 to block serving and compact block relay boundaries | v2.0 shipped bounded transaction relay and mempool participation, so the next safe node-participation expansion is serving validated blocks and compact-block relay before package relay, public defaults, or production full-node readiness | Phases 110–124 implementation evidence remains complete; Phase 125 closed three verification-traceability requirements, and six Phase 126 residual-hardening requirements keep archival blocked |
