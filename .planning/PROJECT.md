...
- v2.1 Block Serving and Compact Block Relay Boundary requirements are being defined in `.planning/REQUIREMENTS.md`.
...
| Scope v2.1 to block serving and compact block relay boundaries | v2.0 shipped bounded transaction relay and mempool participation, so the next safe node-participation expansion is serving validated blocks and compact-block relay before package relay, public defaults, or production full-node readiness | Active; requirements are being defined |
...
***
*Last updated: 2026-07-03 after v2.1 milestone start*
