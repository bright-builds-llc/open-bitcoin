...
- No active requirements file remains after v2.0 archive. Start the next milestone with `/gsd-new-milestone` to create a fresh `.planning/REQUIREMENTS.md`.
...
***
*Last updated: 2026-07-03 after v2.0 milestone archive*
