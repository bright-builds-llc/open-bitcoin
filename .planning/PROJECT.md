...
- ✓ v1.8 Phase 84 validated source-built upgrade, rollback, backup, and state/schema compatibility expectations through the canonical policy and deterministic Phase 84 checker. Evidence: `.planning/phases/84-upgrade-and-rollback-policy/84-VERIFICATION.md`
- ✓ v1.8 Phase 85 validated operator preflight, long-run monitoring, no-progress diagnosis, recovery, support-bundle, and escalation runbooks through canonical docs and deterministic Phase 85 checks. Evidence: `.planning/phases/85-operator-runbooks/85-VERIFICATION.md`
- ✓ v1.8 Phase 86 validated source-built daemon and service-supervision expectations through canonical docs and deterministic Phase 86 checks. Evidence: `.planning/phases/86-service-operation-expectations/86-VERIFICATION.md`
- ✓ v1.8 Phase 87 validated the release-readiness checklist, parity roots, compact entrypoint links, no-claim review, and deterministic Phase 87 checker. Evidence: `.planning/phases/87-release-readiness-checklist/87-VERIFICATION.md`

### Active

- [ ] Add deterministic claim guardrails that fail overbroad production-readiness or deferred-surface language while keeping public-network, real service-manager, and multi-day checks opt-in.
...
| Scope v1.8 to production full-node readiness boundary | v1.7 left production-node readiness deferred, so the next safe step is defining support, upgrade, service, runbook, release-readiness, and evidence gates before any production claim | Phases 82 through 87 shipped the production claim boundary, support matrix, upgrade/rollback policy, runbooks, service expectations, and release-readiness checklist; Phase 88 remains for deterministic claim guardrails |
...
---
*Last updated: 2026-06-23 after completing Phase 87 release-readiness checklist*
