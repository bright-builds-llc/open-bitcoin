# Requirements Archive: v1.3 Public Mainnet Sync Proof and Node Hardening

**Archived:** 2026-06-02
**Status:** SHIPPED

No active milestone requirements file remains after archive. Start the next
milestone with `/gsd-new-milestone` to create fresh active requirements.
