# Milestone v1.2 Roadmap Archive

**Milestone:** v1.2 Full Mainnet Network Syncing
**Status:** ✅ SHIPPED 2026-05-23
**Phases:** 35 through 41
**Plans:** 13

This file preserves the full roadmap snapshot that was current when v1.2
shipped. The detailed phase execution history for this milestone is archived
under `.planning/milestones/v1.2-phases/`.
...
**Plans:** [35-01](v1.2-phases/35-daemon-mainnet-sync-activation/35-01-PLAN.md), [35-02](v1.2-phases/35-daemon-mainnet-sync-activation/35-02-PLAN.md), [35-03](v1.2-phases/35-daemon-mainnet-sync-activation/35-03-PLAN.md)
...
**Plans:** [37-01](v1.2-phases/37-header-first-mainnet-sync-integration/37-01-PLAN.md)
...
**Plans:** [38-01](v1.2-phases/38-block-download-connect-and-restart-recovery/38-01-PLAN.md)
...
**Plans:** [39-01](v1.2-phases/39-operator-sync-observability-and-control/39-01-PLAN.md)
...
**Plans:** [40-01](v1.2-phases/40-live-mainnet-smoke-docs-and-parity-closeout/40-01-PLAN.md)
...
**Depends on:** Phase 40
**Plans:** [41-01](v1.2-phases/41-audit-and-revisit-all-the-security-analyses-throughout-the-p/41-01-PLAN.md)
...
Plans:
- [x] [41-01 Security Analysis Audit And Follow-Up Closeout](v1.2-phases/41-audit-and-revisit-all-the-security-analyses-throughout-the-p/41-01-PLAN.md)
