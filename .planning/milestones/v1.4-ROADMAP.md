...
- ✅ **v1.4 Mainnet IBD Convergence and Peer Compatibility** - Phases 54 through 59 (shipped 2026-06-05).
...
- [x] **Phase 57: Block Download and Connect Progress** - Prove bounded block download and first validated block connection beyond the v1.4 target boundary. (completed 2026-06-04)
- [x] **Phase 58: Same-Datadir Restart and Resume Evidence** - Prove durable resume after observed live progress without duplicate connects. (completed 2026-06-05)
- [x] **Phase 59: Operator Evidence, Threat Model, and Release Boundaries** - Close v1.4 with coherent support evidence, docs, security analysis, and claim boundaries. (completed 2026-06-05)
...
Plans:
- [x] 58-01-PLAN.md - Prove durable same-datadir resume without duplicate block work.
- [x] 58-02-PLAN.md - Add live-smoke restart/resume evidence.
- [x] 58-03-PLAN.md - Add recovery diagnosis, operator guidance, and parity wording.
...
| 58. Same-Datadir Restart and Resume Evidence | 3/3 | Complete   | 2026-06-05 |
...
Complete the v1.4 milestone archive:
