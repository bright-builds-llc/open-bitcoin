# Requirements Archive: v2.0 Transaction Relay and Mempool Participation Boundary

**Archived:** 2026-07-03
**Status:** SHIPPED

No active requirements file remains after v2.0 archive. Start the next milestone
