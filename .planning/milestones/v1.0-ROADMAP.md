...
- [x] **Phase 8: RPC, CLI, and Config Parity** - Expose node and wallet behavior through compatible operator interfaces. (completed 2026-04-24)
...
- [x] 08-06-PLAN.md — Close RPC dispatcher semantics and cookie-auth hardening gaps.
- [x] 08-07-PLAN.md — Close CLI config parsing and stdin behavior gaps.
- [x] 08-08-PLAN.md — Close Phase 8 parity documentation and final verification evidence.
...
| 6. P2P Networking and Sync | 4/4 | Complete | 2026-04-14 |
| 7. Wallet Core and Adapters | 4/4 | Complete | 2026-04-17 |
| 7.1. Codebase Maintainability Refactor Wave | 3/3 | Complete | 2026-04-18 |
| 7.2. Protocol Constant Clarity Cleanup | 1/1 | Complete | 2026-04-19 |
| 7.3. Reduce nesting with early returns | 3/3 | Complete | 2026-04-19 |
| 7.4. Sweep the codebase for let-else opportunities | 1/1 | Complete | 2026-04-20 |
| 7.5. Fix consensus parity gaps in contextual header validation and lax DER signature verification | 4/4 | Complete | 2026-04-22 |
| 7.6. Enforce coinbase subsidy-plus-fees limits on the consensus and active chainstate paths | 3/3 | Complete | 2026-04-22 |
| 8. RPC, CLI, and Config Parity | 8/8 | Complete | 2026-04-24 |
