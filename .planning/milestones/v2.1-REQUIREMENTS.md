# Requirements Archive: v2.1 Block Serving and Compact Block Relay Boundary

**Archived:** 2026-07-22
**Status:** SHIPPED

No active requirements file remains after the v2.1 archive. Start the next milestone with `/gsd-new-milestone` to create a fresh `.planning/REQUIREMENTS.md`.
