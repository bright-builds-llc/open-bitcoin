...
fn decode_payload_decoder_errors_are_resource_labels() {
    ...
    let trailing_ping_header = MessageHeader {
        ...
        checksum: super::super::checksum(&trailing_ping_payload),
    };
    ...
    let malformed_version_header = MessageHeader {
        ...
        checksum: super::super::checksum(&malformed_version_payload),
    };
    let unknown_event = super::super::resource_event_for_decode_error(
        crate::NetworkError::UnknownCommand("mystery".to_string()),
    );
    let checksum_event =
        super::super::resource_event_for_decode_error(crate::NetworkError::InvalidChecksum);
