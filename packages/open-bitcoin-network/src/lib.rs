...
pub use resource::{
    ...
    InboundResourceEvent, PHASE94_MAX_AGGREGATE_QUEUED_MESSAGES,
    ...
    PHASE94_MAX_INBOUND_REQUEST_INVENTORY_ITEMS, PHASE94_MAX_INBOUND_RUNTIME_PAYLOAD_BYTES,
    PHASE94_MAX_INBOUND_TX_REQUESTS_PER_PEER, PHASE94_MAX_PEER_QUEUED_MESSAGES,
    PHASE94_MAX_PEER_READ_QUEUE_BYTES, PHASE94_MAX_PEER_WRITE_QUEUE_BYTES, QueuePressureInput,
    RequestPressureInput, ResourceGovernanceDecision, ResourceGovernancePolicy,
    ResourceGovernanceSource, ResourcePressureLabel, ResourceViolationLabel,
};
