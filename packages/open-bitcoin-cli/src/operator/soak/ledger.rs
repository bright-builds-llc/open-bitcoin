...
pub(crate) struct SoakCheckpointStatus {
    ...
    pub(crate) maybe_recovery_action_class_label: Option<String>,
    pub(crate) maybe_recovery_cause_label: Option<String>,
    pub(crate) maybe_recovery_next_action: Option<String>,
    ...
    pub(crate) maybe_progress_credit_work: Option<String>,
    pub(crate) maybe_progress_credit_source_unix_seconds: Option<u64>,
    pub(crate) progress_credit_rejected_activity_labels: Vec<String>,
    pub(crate) maybe_expected_progress_window_seconds: Option<u64>,
    pub(crate) maybe_no_progress_threshold_state_label: Option<String>,
    pub(crate) maybe_no_progress_threshold_seconds: Option<u64>,
    pub(crate) maybe_last_useful_work_kind_label: Option<String>,
    pub(crate) maybe_last_useful_work_height: Option<u64>,
    pub(crate) maybe_last_peer_contribution_label: Option<String>,
    pub(crate) maybe_stalled_subsystem_label: Option<String>,
    pub(crate) maybe_stall_confidence_label: Option<String>,
    pub(crate) stall_evidence_basis: Vec<String>,
    pub(crate) maybe_stall_next_action: Option<String>,
    pub(crate) maybe_resource_bound_state_label: Option<String>,
    pub(crate) resource_bound_labels: Vec<String>,
    pub(crate) maybe_resource_bound_next_action: Option<String>,
