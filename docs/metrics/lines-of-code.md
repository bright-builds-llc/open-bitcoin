...
| Metric | Value |
| --- | --- |
| Included files | 1,034 |
| Total lines | 290,841 |
| Code/content lines | 253,615 |
| Comment-only lines | 12,899 |
| Blank lines | 24,327 |
...
| open-bitcoin-node | 204 | 24,680 | 29,578 | 40 | 54,298 | 119.8% |
| open-bitcoin-primitives | 9 | 877 | 0 | 20 | 897 | 0.0% |
| open-bitcoin-rpc | 78 | 9,956 | 9,754 | 57 | 19,767 | 98.0% |
...
| --- | --- | --- | --- | --- | --- |
| Rust tests | 393 | 108,799 | 92,749 | 7,600 | 8,450 |
| Rust production | 335 | 99,444 | 86,492 | 3,604 | 9,348 |
| TypeScript/Bun scripts | 237 | 65,743 | 58,465 | 1,615 | 5,663 |
...
| scripts/check-phase122-compact-relay-peer-completion.test.ts | 254 |
| scripts/check-phase122-compact-relay-peer-completion.ts | 421 |
...
| scripts/check-phase126-compact-relay-residual-hardening.test.ts | 456 |
| scripts/check-phase126-compact-relay-residual-hardening.ts | 429 |
...
| scripts/check-phase128-production-compact-announcement-transport.ts | 548 |
...
| 10 | packages/open-bitcoin-node/src/network/admission_bridge.rs | Rust production | 626 |
| 11 | packages/open-bitcoin-wallet/src/address.rs | Rust production | 626 |
| 12 | packages/open-bitcoin-rpc/src/config/loader.rs | Rust production | 625 |
| 13 | scripts/verify.sh | Shell scripts | 625 |
...
| Input fingerprint | bb1e4feedc6a760888dae44643c4b51042b134aecf032785adfab58cf2fa0173 |
