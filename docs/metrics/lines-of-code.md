...
| Included files | 346 |
| Total lines | 128,631 |
| Code/content lines | 114,015 |
| Comment-only lines | 3,877 |
| Blank lines | 10,739 |
...
| open-bitcoin-cli | 78 | 18,164 | 15,652 | 92 | 33,908 | 86.2% |
...
| open-bitcoin-node | 47 | 11,482 | 10,221 | 36 | 21,739 | 89.0% |
...
| --- | --- | --- | --- | --- | --- |
| Rust production | 203 | 57,127 | 49,729 | 1,784 | 5,614 |
| Rust tests | 56 | 44,029 | 38,848 | 1,949 | 3,232 |
| TypeScript/Bun scripts | 28 | 11,748 | 10,538 | 93 | 1,117 |
| Fixture/data | 6 | 8,233 | 8,228 | 5 | 0 |
| Shell scripts | 13 | 3,472 | 3,089 | 40 | 343 |
...
| scripts/run-live-mainnet-smoke.ts | 3,572 |
...
| 3 | scripts/run-live-mainnet-smoke.ts | TypeScript/Bun scripts | 3,572 |
...
| 7 | scripts/test-run-live-mainnet-smoke.sh | Shell scripts | 1,921 |
...
| 16 | packages/open-bitcoin-node/src/status/tests.rs | Rust tests | 1,022 |
...
| Input fingerprint | 28d83efb865be34df45e991f42e03b5b5b1c25a0b7275e90b6fc88581b2b01b5 |
