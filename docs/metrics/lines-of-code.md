...
| Included files | 262 |
| Total lines | 80,410 |
| Code/content lines | 71,012 |
| Comment-only lines | 2,449 |
| Blank lines | 6,949 |
...
| --- | --- | --- | --- | --- | --- |
| Rust production | 159 | 40,829 | 35,147 | 1,459 | 4,223 |
...
| Input fingerprint | c6b71a12d3d6a2b00f55ba2a3e2d3402505b161876ecb53f87f50b4e5b0dab01 |
