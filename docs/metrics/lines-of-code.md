...
| Metric | Value |
| --- | --- |
| Included files | 1,152 |
| Total lines | 329,739 |
| Code/content lines | 287,303 |
| Comment-only lines | 14,991 |
| Blank lines | 27,445 |
...
| open-bitcoin-chainstate | 22 | 2,441 | 4,289 | 26 | 6,756 | 175.7% |
...
| open-bitcoin-node | 260 | 31,393 | 41,210 | 40 | 72,643 | 131.3% |
...
| --- | --- | --- | --- | --- | --- |
| Rust tests | 441 | 127,156 | 107,980 | 9,110 | 10,066 |
| Rust production | 377 | 110,789 | 96,314 | 4,088 | 10,387 |
...
| 18 | packages/open-bitcoin-node/src/sync/runtime_state.rs | Rust production | 625 |
| 19 | packages/open-bitcoin-rpc/src/config/loader.rs | Rust production | 625 |
| 20 | packages/open-bitcoin-rpc/src/package_projection.rs | Rust production | 625 |
...
| Input fingerprint | a090be18ee501303f2a9e5e9c9261c45ab832a27fd36b1fc4544cd212c35740c |
