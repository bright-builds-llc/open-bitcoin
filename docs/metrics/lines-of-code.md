...
| Included files | 321 |
| Total lines | 116,927 |
| Code/content lines | 103,671 |
| Comment-only lines | 3,487 |
| Blank lines | 9,769 |
...
| TypeScript/Bun scripts | 21 | 8,963 | 8,094 | 24 | 845 |
...
| scripts/check-phase73-uat-verification.test.ts | 370 |
| scripts/check-phase73-uat-verification.ts | 518 |
...
| Input fingerprint | 2e5a7feb98d28ef93fa8a728d9393fea309e075acf1d5ae7aa878858f97ef223 |
