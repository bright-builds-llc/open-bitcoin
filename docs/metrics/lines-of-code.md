...
| Included files | 640 |
| Total lines | 278,205 |
| Code/content lines | 244,214 |
| Comment-only lines | 10,836 |
| Blank lines | 23,155 |
...
| open-bitcoin-cli | 93 | 21,734 | 20,002 | 97 | 41,833 | 92.0% |
| open-bitcoin-codec | 15 | 1,811 | 779 | 28 | 2,621 | 43.0% |
| open-bitcoin-consensus | 33 | 6,592 | 7,719 | 28 | 14,339 | 117.1% |
| open-bitcoin-core | 3 | 39 | 0 | 36 | 75 | 0.0% |
| open-bitcoin-mempool | 62 | 10,079 | 14,508 | 30 | 24,617 | 143.9% |
| open-bitcoin-network | 58 | 13,231 | 19,082 | 30 | 32,343 | 144.2% |
| open-bitcoin-node | 101 | 22,141 | 26,137 | 40 | 48,318 | 118.0% |
| open-bitcoin-primitives | 9 | 877 | 0 | 20 | 897 | 0.0% |
| open-bitcoin-rpc | 47 | 9,952 | 9,352 | 57 | 19,361 | 94.0% |
...
| --- | --- | --- | --- | --- | --- |
| Rust tests | 122 | 101,864 | 88,293 | 5,796 | 7,775 |
| Rust production | 323 | 95,449 | 83,086 | 3,369 | 8,994 |
| TypeScript/Bun scripts | 136 | 64,192 | 57,059 | 1,603 | 5,530 |
| Fixture/data | 6 | 8,233 | 8,228 | 5 | 0 |
| Shell scripts | 13 | 4,369 | 3,901 | 57 | 411 |
...
| scripts/check-phase102-orphan-admission-bridge.ts | 710 |
...
| scripts/check-phase132-typed-package-staged-admission.ts | 883 |
| scripts/check-phase133-package-aware-download-orphan-bridge.test.ts | 305 |
| scripts/check-phase133-package-aware-download-orphan-bridge.ts | 540 |
...
| 2 | packages/open-bitcoin-node/src/sync/tests.rs | Rust tests | 7,966 |
| 3 | packages/open-bitcoin-network/src/peer/tests.rs | Rust tests | 6,766 |
| 4 | scripts/run-live-mainnet-smoke.ts | TypeScript/Bun scripts | 3,816 |
| 5 | packages/open-bitcoin-consensus/src/script/tests.rs | Rust tests | 3,312 |
| 6 | packages/Cargo.lock | TOML/config | 3,204 |
| 7 | packages/open-bitcoin-node/src/network/tests.rs | Rust tests | 2,975 |
| 8 | packages/open-bitcoin-cli/src/operator/support/tests.rs | Rust tests | 2,940 |
| 9 | packages/open-bitcoin-rpc/src/dispatch/tests.rs | Rust tests | 2,793 |
| 10 | packages/open-bitcoin-cli/tests/operator_binary.rs | Rust tests | 2,691 |
| 11 | packages/open-bitcoin-cli/src/operator/status/tests.rs | Rust tests | 2,589 |
...
| 17 | packages/open-bitcoin-mempool/src/pool/tests/package_policy_cases.rs | Rust tests | 1,633 |
| 18 | packages/open-bitcoin-consensus/src/block/tests.rs | Rust tests | 1,594 |
| 19 | packages/open-bitcoin-cli/src/operator/soak/tests/runtime.rs | Rust tests | 1,578 |
| 20 | packages/open-bitcoin-chainstate/src/engine/tests.rs | Rust tests | 1,553 |
...
| Input fingerprint | 8d29f4d8480920c3afb38dd223922b13d11f1b40387ea7063b78ae467e1e3e4c |
