...
| Included files | 558 |
| Total lines | 233,906 |
| Code/content lines | 205,786 |
| Comment-only lines | 8,310 |
| Blank lines | 19,810 |
...
| open-bitcoin-cli | 93 | 21,734 | 19,716 | 97 | 41,547 | 90.7% |
...
| open-bitcoin-network | 54 | 12,006 | 17,492 | 30 | 29,528 | 145.7% |
| open-bitcoin-node | 93 | 19,001 | 22,946 | 38 | 41,985 | 120.8% |
| open-bitcoin-primitives | 9 | 877 | 0 | 20 | 897 | 0.0% |
| open-bitcoin-rpc | 44 | 8,894 | 7,546 | 57 | 16,497 | 84.8% |
...
| scripts/check-phase117-parity-uat-release-boundary.test.ts | 689 |
| scripts/check-phase117-parity-uat-release-boundary.ts | 545 |
...
| scripts/check-phase122-compact-relay-peer-completion.ts | 374 |
...
| scripts/check-phase124-milestone-closeout-reconciliation.fixtures.ts | 511 |
| scripts/check-phase124-milestone-closeout-reconciliation.test.ts | 613 |
| scripts/check-phase124-milestone-closeout-reconciliation.ts | 536 |
| scripts/check-phase124-milestone-gap-closure.test.ts | 481 |
| scripts/check-phase124-milestone-gap-closure.ts | 874 |
...
| 2 | packages/open-bitcoin-node/src/sync/tests.rs | Rust tests | 7,798 |
| 3 | packages/open-bitcoin-network/src/peer/tests.rs | Rust tests | 6,052 |
...
| 9 | packages/open-bitcoin-node/src/network/tests.rs | Rust tests | 2,659 |
...
| 19 | packages/open-bitcoin-rpc/src/inbound_listener/tests.rs | Rust tests | 1,461 |
| 20 | packages/open-bitcoin-wallet/src/wallet/tests.rs | Rust tests | 1,384 |
...
| Input fingerprint | 8cebfd84f02b0257ee512150d4e134d62dce8724ca7df4c4854b4d6d85560024 |
