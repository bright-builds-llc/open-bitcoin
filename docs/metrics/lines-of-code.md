...
| Included files | 269 |
| Total lines | 84,779 |
| Code/content lines | 74,772 |
| Comment-only lines | 2,627 |
| Blank lines | 7,380 |
...
| open-bitcoin-network | 11 | 1,742 | 1,426 | 30 | 3,198 | 81.9% |
| open-bitcoin-node | 27 | 6,688 | 3,000 | 36 | 9,724 | 44.9% |
...
| --- | --- | --- | --- | --- | --- |
| Rust production | 164 | 43,207 | 37,244 | 1,508 | 4,455 |
| Rust tests | 45 | 26,771 | 23,608 | 1,084 | 2,079 |
...
| 7 | packages/open-bitcoin-node/src/sync/tests.rs | Rust tests | 1,378 |
...
| 16 | packages/open-bitcoin-network/src/peer/tests.rs | Rust tests | 708 |
...
| Input fingerprint | f087068f0415d977873ac4386dba627bc67f4d828a44aa7f1770082b1682679f |
