...
| Included files | 281 |
| Total lines | 91,625 |
| Code/content lines | 80,909 |
| Comment-only lines | 2,762 |
| Blank lines | 7,954 |
...
| open-bitcoin-cli | 53 | 11,203 | 7,566 | 86 | 18,855 | 67.5% |
...
| open-bitcoin-node | 32 | 7,826 | 3,689 | 36 | 11,551 | 47.1% |
| open-bitcoin-primitives | 9 | 877 | 0 | 20 | 897 | 0.0% |
| open-bitcoin-rpc | 32 | 5,676 | 2,564 | 53 | 8,293 | 45.2% |
...
| --- | --- | --- | --- | --- | --- |
| Rust production | 171 | 45,785 | 39,571 | 1,544 | 4,670 |
| Rust tests | 46 | 28,715 | 25,332 | 1,174 | 2,209 |
...
| 4 | packages/open-bitcoin-node/src/sync/tests.rs | Rust tests | 2,067 |
...
| 11 | packages/open-bitcoin-rpc/src/dispatch/tests.rs | Rust tests | 1,038 |
...
| Input fingerprint | 51a6efb311cf7cec816d4798ab9c7c285f85bf104a5f97338509cdeae3399798 |
