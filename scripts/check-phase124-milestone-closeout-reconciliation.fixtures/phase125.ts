...
export function createVerifyScript(
  ...
  return [
    ...
    `run_step "test Phase 138" ${PHASE138_TEST}`,
    `run_step "check Phase 138" ${PHASE138_CHECK}`,
  ].join("\n");
}
