...
export function fixtureFiles(): Map<TargetFile, string> {
...
export function removeFromAllFiles(files: Map<TargetFile, string>, needle: string): void {
...
export function parityIndexText(): string {
...
export function p2pCatalogText(): string {
  return [
...
export function releaseReadinessText(): string {
  return [
...
export function productionBoundaryText(): string {
  return [
...
export function supportMatrixText(): string {
  return [
...
export function runtimeGuideText(): string {
  return [
...
export function redactionText(): string {
  return [
...
export function supportTestsText(): string {
  return [
...
export function phaseTraceRows(): string[] {
  const rows = [
...
export function verifyScriptText(): string {
  return [
    "#!/usr/bin/env bash",
    "set -euo pipefail",
...
export { mkdirSync, mkdtempSync, rmSync, writeFileSync, tmpdir, path, checkPhase95NetworkParticipationReleaseBoundary };
