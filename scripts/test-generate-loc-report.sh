...
run_scope_and_structure_case() {
  ...
  write_lines "${repo_dir}/scripts/check-phase63-service-lifecycle.ts" 4 "console.log"
  ...
  assert_contains "${repo_dir}/${report_path}" "## Included TypeScript/Bun Scripts"
  ...
  assert_contains "${repo_dir}/${report_path}" "scripts/check-phase63-service-lifecycle.ts"
